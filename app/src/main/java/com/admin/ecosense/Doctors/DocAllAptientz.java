...
public class DocAllAptientz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView101.setText("All ");
        textView102.setText("Patients");
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Eat = jsonObj.getJSONArray("getpatientz");
                        ...
                        if(mItems.size()>0) {
                            PatientDocAdapter hadapter = new PatientDocAdapter(DocAllAptientz.this, mItems);
                            LinearLayoutManager mLayoutManager = new LinearLayoutManager(DocAllAptientz.this);
