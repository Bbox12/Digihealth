...
public class FutureConsultation extends AppCompatActivity {
    ...
    private void populate() {
        ...
        if(MenuArray.size()!=0) {
            ...
            All_fragment_adapter sAdapter = new All_fragment_adapter(FutureConsultation.this, MenuArray);
            ...
            LinearLayoutManager mHorizontal = new LinearLayoutManager(FutureConsultation.this, LinearLayoutManager.VERTICAL, false);
