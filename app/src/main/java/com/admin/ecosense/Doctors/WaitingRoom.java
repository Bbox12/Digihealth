...
public class WaitingRoom extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView101.setText("Waiting  ");
        textView102.setText("room");
    ...
    private void populate() {
        ...
        if(MenuArray.size()!=0) {
            ...
            All_fragment_adapter sAdapter = new All_fragment_adapter(WaitingRoom.this, MenuArray);
            ...
            LinearLayoutManager mHorizontal = new LinearLayoutManager(WaitingRoom.this, LinearLayoutManager.VERTICAL, false);
