...
public class Oxygen extends AppCompatActivity  {
    ...
    private static final String TAG = Oxygen.class.getSimpleName();
...
//        _t1=findViewById(R.id._t1);
        ...
        _T1=findViewById(R.id._t1);
        _T1.setText("Please select your symptoms ");
    ...
    private class GetUser extends AsyncTask<Void, Integer, String> {
        ...
        protected void onPostExecute(String file_url) {
                ...
                if(mSyms.size()>0) {
                    ...
                    _symsAdapter sAdapter = new _symsAdapter(Oxygen.this, mSyms);
                    sAdapter.notifyDataSetChanged();
                    sAdapter.setFrom(_from);
                    ...
                    LinearLayoutManager mHorizontal = new LinearLayoutManager(Oxygen.this, LinearLayoutManager.VERTICAL, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.action_notification:
                if (_PhoneNo != null) {
                    Intent o = new Intent(Oxygen.this, Account_settings.class);
                    startActivity(o);
                    overridePendingTransition(R.anim.slide_up1, R.anim.slide_down1);
                } else {
                    Intent o = new Intent(Oxygen.this, ServiceOffer.class);
                    startActivity(o);
            ...
            case R.id.action_noti:
                Intent o = new Intent(Oxygen.this, NotificationAll.class);
                startActivity(o);
