...
import com.admin.ecosense.Contacts.QuestionAdapter;
...
public class HealthInfo extends AppCompatActivity  {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            JSONArray Contacts = jsonObj.getJSONArray("questionss");
                        ...
                        if (mItems.size() != 0) {
                            ...
                            QuestionAdapter sAdapter = new QuestionAdapter(HealthInfo.this, mItems);
                            sAdapter.notifyDataSetChanged();
                            Sosrv.setAdapter(sAdapter);
                            LinearLayoutManager mLayoutManager = new LinearLayoutManager(HealthInfo.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(_PhoneNo!=null) {
            Intent o = new Intent(HealthInfo.this, Account_settings.class);
            startActivity(o);
            overridePendingTransition(R.anim.slide_up1, R.anim.slide_down1);
        }else{
            Intent o = new Intent(HealthInfo.this, ServiceOffer.class);
            startActivity(o);
